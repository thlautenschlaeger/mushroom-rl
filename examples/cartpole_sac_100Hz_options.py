...
def experiment(alg, n_epochs, n_steps, n_steps_test, seed):
    ...
    mdp.seed(seed)
    rarhmm = torch.load(
        os.path.abspath(os.path.join(__file__, '..', '..')) + '/mushroom_rl/sds/envs/hybrid/models/neural_rarhmm_cartpole_cart.pkl',
        map_location='cpu')
...
if __name__ == '__main__':
    ...
    torch.save(experiments,
               os.path.abspath(os.path.join(__file__, '..', '..')) + '/results/option_sac_cartpole100Hz_experiments.pkl')
    #
