...
from mushroom_rl.sds.utils import sample_env
...
def identify():
    ...
    torch.save(rarhmm, open(os.path.abspath(
        os.path.join(__file__, '..',
                     '..')) + '/envs/hybrid/models/' + rarhmm.trans_type + "_rarhmm_pendulum_cart.pkl",
                            "wb"))
...
if __name__ == "__main__":
    ...
    # import torch
    # import os
    # torch.load(os.path.abspath(os.path.join(__file__, '..',
    #                  '..')) + '/sds/envs/hybrid/models/neural_rarhmm_pendulum_cart.pkl', map_location='cpu')