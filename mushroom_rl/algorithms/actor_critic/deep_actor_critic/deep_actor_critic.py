...
class DeepOptionAC(OptionAgent):

    def __init__(self, mdp_info, policy, actor_optimizer, parameters, n_options):
        """
        Constructor.
        ...
        if actor_optimizer is not None:
            ...
            for o in range(n_options):
                self._optimizer.append(actor_optimizer['class'](
                    parameters[o], **actor_optimizer['params'])
                )
        ...
        super().__init__(mdp_info, policy, n_options)
    ...
    def _optimize_actor_parameters(self, loss, option):
        """
        Method used to update actor parameters to maximize a given loss.
        ...
        """
        self._optimizer[option].zero_grad()
        loss.backward(create_graph=True, retain_graph=True)
        self._clip_gradient()
        self._optimizer[option].step()
